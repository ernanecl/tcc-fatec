...
class Evento{
    ...
    static validacoes(){
        return [
            ...
            check('organizador').notEmpty().withMessage("O evento precisa ser preenchido"),
            ...
            check('incricao').isLength({min: 3, max: 3}).withMessage("Digite SIM ou NÃO para inscrição"),
            ...
            check('categoria').notEmpty().withMessage("A categoria precisa ser preenchida"),
            check('visibilidade').notEmpty().withMessage("A visibilidade precisa ser preenchida"),
